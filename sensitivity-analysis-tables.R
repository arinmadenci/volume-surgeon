...
results$sensitivity_trial_4 <- tt_4_parallel_sensitivity_function(cores=11, range=-5:5)
results$sensitivity_trial_4_parametric <- tt_4_parametric_parallel_sensitivity_function(cores=11, range=-5:5)
...
results$sensitivity_trial_6 <- tt_6_parallel_sensitivity_function(cores=11, range=-5:5)
results$sensitivity_trial_6_parametric <- tt_6_parametric_parallel_sensitivity_function(cores=11, range=-5:5)
